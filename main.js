...
document.getElementById('cor1').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor1;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor1);
...
document.getElementById('cor2').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor2;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor2);
...
document.getElementById('cor3').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor3;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor3);
...
document.getElementById('cor4').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor4;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor4);
...
document.getElementById('cor5').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor5;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor5);
...
document.getElementById('cor6').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor6;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor6);
...
document.getElementById('cor7').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor7;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor7);
...
document.getElementById('cor8').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor8;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor8);
...
document.getElementById('cor9').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor9;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor9);
...
document.getElementById('cor10').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor10;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor10);
...
document.getElementById('cor11').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor11;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor11);
...
document.getElementById('cor12').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor12;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor12);
...
document.getElementById('cor13').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor13;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor13);
...
document.getElementById('cor14').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor14;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor14);
...
document.getElementById('cor15').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor15;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor15);
...
document.getElementById('cor16').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor16;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor16);
...
document.getElementById('cor17').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor17;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor17);
...
document.getElementById('cor18').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor18;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor18);
...
document.getElementById('cor19').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor19;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor19);
...
document.getElementById('cor20').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor20;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor20);
...
document.getElementById('cor21').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor21;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor21);
...
document.getElementById('cor22').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor22;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor22);
...
document.getElementById('cor23').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor23;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor23);
...
document.getElementById('cor24').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor24;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor24);
...
document.getElementById('cor25').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor25;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor25);
...
document.getElementById('cor26').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor26;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor26);
...
document.getElementById('cor27').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor27;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor27);
...
document.getElementById('cor28').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor28;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor28);
...
document.getElementById('cor29').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor29;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor29);
...
document.getElementById('cor30').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor30;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor30);
...
document.getElementById('cor31').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor31;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor31);
...
document.getElementById('cor32').addEventListener('click', function (e) {
  if (document.getElementById('base').checked) {
    ...
    document.getElementById('VE').style.backgroundColor = cor32;
  }if(document.getElementById('vista1').checked){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = cor32);
